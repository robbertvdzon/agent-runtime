...
|---|---:|---:|---:|---|
| Productie (standaard) | 384 MiB | 512 MiB | 256 MiB | `deploy/production/backend-memory.yaml` |
| Acceptatie | 288 MiB | 384 MiB | 128 MiB | `deploy/acceptance/backend-memory.yaml` |
